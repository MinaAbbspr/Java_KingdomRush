...
public class Level4 implements Initializable {
            ...
            switch (kind){
                case "Bird" -> {
                    for(int i=0; i<number; i++){
                        ...
                        enemies.getLast().getRaider().getvBox().setLayoutY(enemies.getLast().getRaider().getPathwayFractures().getFirst().getY()-50);
                        enemies.getLast().getRaider().getvBox().setLayoutX(enemies.getLast().getRaider().getPathwayFractures().getFirst().getX());
        ...
        public void initialize(URL url, ResourceBundle resourceBundle) {
            ...
            towers.put(map.getTowersCoordinate().get(1), img_tower1);
            towers.put(map.getTowersCoordinate().get(2), img_tower2);
            ...
            towers.put(map.getTowersCoordinate().get(6), img_tower6);
            towers.put(map.getTowersCoordinate().get(7), img_tower7);
