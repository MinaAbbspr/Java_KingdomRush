...
public class Level3 implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        towers.put(map.getTowersCoordinate().get(2), img_tower7);
        towers.put(map.getTowersCoordinate().get(3), img_tower6);
        towers.put(map.getTowersCoordinate().get(4), img_tower4);
        towers.put(map.getTowersCoordinate().get(5), img_tower3);
        towers.put(map.getTowersCoordinate().get(6), img_tower1);
        towers.put(map.getTowersCoordinate().get(7), img_tower5);

        towerController.add(new ArtilleryController(new Artillery(new Coordinate(830,486))));
        towerController.getLast().updateLevel();
        towerController.getLast().updateLevel();
        towerController.getLast().updateLevel();
        towerController.getLast().action(enemies);
